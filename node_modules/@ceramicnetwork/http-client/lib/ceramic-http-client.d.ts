...
import { CreateOpts, CeramicApi, CeramicCommit, Context, Stream, StreamConstructor, StreamHandler, LoadOpts, MultiQuery, PinApi, UpdateOpts, AnchorStatus } from '@ceramicnetwork/common';
...
export declare class CeramicClient implements CeramicApi {
    ...
    findStreamConstructor<T extends Stream>(type: number): StreamConstructor<T>;
    private buildStream;
